...
public class CircularProgressButton extends Button {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int progressColor = getColor(R.color.colorPrimary);//进度条颜色
            int white = getColor(R.color.cpb_white);
            int progressBgColor = getColor(R.color.cpb_grey);//进度条底部背景色
            ...
            mColorIndicator = attr.getColor(R.styleable.CircularProgressButton_cpb_colorIndicator, progressColor);
            mColorIndicatorBackground =
                    attr.getColor(R.styleable.CircularProgressButton_cpb_colorIndicatorBackground, progressBgColor);
        } finally {
            attr.recycle();
        }
    }
