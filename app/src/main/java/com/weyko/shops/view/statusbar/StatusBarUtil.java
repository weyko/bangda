package com.weyko.shops.view.statusbar;
...
public class StatusBarUtil {
     ...
     * @param color        状态栏颜色值
     */
    public static void setColorForDrawerLayout(Activity activity, ViewGroup drawerLayout, @ColorInt int color) {
     ...
     * @param color        状态栏颜色值
     */
    public static void setColorNoTranslucentForDrawerLayout(Activity activity, ViewGroup drawerLayout, @ColorInt int color) {
